...
public class FindInterSectionElement {
	...
	/*
    Que-  Given two integer arrays nums1 and nums2, return an array of their intersection. Each element in the result must be unique and you may return the result in any order.
...
10. If it fails then debug to solve it
	...
	Constraints:No Sort
	 * Pseudo code:  
	 *  1. Compare two arrays to find the common elements
	 *  2. If found, add it to the set 
	 *  3. Return common elements as array
	 *  
	 *  Complexity:
	 *  Time - O(n^2)
	 *  Space - O(n)	 
