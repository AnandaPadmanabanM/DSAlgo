...
public class ShortestDistanceToCharacter {
	...
	public void testData01()
	{
		...
		char matchChar = 'e';
		Assert.assertArrayEquals(findShortestDistance(input, matchChar), new int[] {3,2,1,0,1,0,0,1,2,2,1,0});	
	}
	...
	/* Check for length of the array, if it's empty return empty array
	 * Create a int[] retArr of string length
	 * Iterate the input
	 * 	  Initialsie the minLength to store closest value
	 *    Iterate through the input, if match found, continue with the next index
